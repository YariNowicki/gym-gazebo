...
class DeepQ:
    ...
    def createModel(self):
        ...
        model = Sequential()
        model.add(Convolution2D(16, (3, 3), subsample=(2, 2), input_shape=(img_channels, img_rows, img_cols), padding='same'))
    ...
    def selecte(self, qValues, explorationRate):
        rand = random.random()
...
if __name__ == '__main__':
    env = gym.make('hector-v0')
    outdir = '/tmp/gazebo_gym_experiments/'

    continue_execution = False
    # fill this if continue_execution=True
    weights_path = '/tmp/turtle_c2c_dqn_ep100.h5'
    ...
    for epoch in xrange(current_epoch + 1, epochs + 1, 1):
        ...
        for t in xrange(steps):
            ...
            action = deepQ.selectActionByProbability(qValues, explorationRate)
